...
export function DashboardTopBar({ businessName: bProp, initials: iProp, planStatus: psProp, trialDays: tdProp }: TopBarProps) {
  ...
  return (
    <header
      className="sticky top-0 z-30 flex items-center px-4 lg:px-6 gap-4 shrink-0"
            ...
            >
              ...
              <div className="py-1">
                <button
                  ...
                  style={{ color: '#6b6b6b' }}
                  onClick={() => { setDropdownOpen(false); toast('Coming soon — this feature is being built.', 'info') }}
